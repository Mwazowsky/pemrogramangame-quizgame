...
public class GameEvents : ScriptableObject {
    ...
    public delegate void    UpdateExplanationUICallback         (Question question);
    public                  UpdateExplanationUICallback         UpdateExplanationUI             = null;

    public delegate void    UpdateNarrationCallback             (Question question);
    public                  UpdateNarrationCallback             UpdateNarration                 = null;

    public delegate void    PlayNarrationCallback               (Question question);
    public                  PlayNarrationCallback               PlayNarration                   = null;
